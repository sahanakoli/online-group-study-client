            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="collapse  bg-[#F3F3F3] rounded-lg mb-8">
                  ...
                  <p className=" px-4 pb-3">The purpose of a study assignment is to help you deepen your knowledge of a subject, develop critical thinking skills, and demonstrate your understanding.</p>
                </div>
              </div>
            </div>
            </div>
